...
- (void)buildAttribute {
    ...
    NSArray *matches = [regx matchesInString:_text options:0 range:NSMakeRange(0, [_text length])];
    ...
    for (int i = 0; i < matches.count; i ++) {
        ...
        NSArray *matches2 = [[_text substringWithRange:result.range] componentsSeparatedByString:@"<"];
